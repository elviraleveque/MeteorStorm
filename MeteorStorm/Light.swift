...
struct Light: View {
    ...
    var body: some View {
        ...
        .frame(width: UIScreen.main.bounds.size.height / 4, height: UIScreen.main.bounds.size.height / 4)
...
struct Light_Previews: PreviewProvider {
    static var previews: some View {
        Light(color: .orange, duration: 10, count: .constant(false), notCount: .constant(false))
    }
}
